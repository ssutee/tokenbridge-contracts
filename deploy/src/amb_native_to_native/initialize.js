...
const {
  homeContracts: { EternalStorageProxy, HomeAMBErc20ToNativeFixedFee },
  foreignContracts: { EternalStorageProxy: ForeignEternalStorageProxy, ForeignAMBNativeToErc677FixedFee }
...
async function initializeBridges({ homeBridge, foreignBridge, homeErc677 }) {
  ...
  await initialize({
    ...
    url: HOME_RPC_URL,
    address: homeBridge,
    abi: HomeAMBErc20ToNativeFixedFee.abi,
  ...
  await initialize({
    ...
    abi: ForeignAMBNativeToErc677FixedFee.abi,
